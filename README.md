...
<p align="center">
 $$\color{#ff9cd4}⋆..\color{#ffb0dd}˚‧\color{#ffd1eb}°˚°\color{#ffe6f4}₊\ \color{#ffffff}୨✦୧\ \color{#ffe6f4}₊\ \color{#ffd1eb}°˚°\color{#ffb0dd}‧˚\color{#ff9cd4}..⋆$$
</p>
...
<p align=center>
$\color{#ffd1eb}{꒰ ♡ ꒱}$ <img src="https://files.catbox.moe/halwvp.gif"> <img src="https://files.catbox.moe/9gflth.gif"> <img src="https://files.catbox.moe/4o33ej.gif">   <img src="https://files.catbox.moe/c27x4j.png"> $\color{#ffffff}{꒰ ♡ ꒱}$
</p>
...
$$\color{#ffffff}꒰১\ \color{#ffffff}I'm\ \color{#ffe6f4}Nad\color{#ffd1eb}nad!\ \color{#ffb0dd}You\ \color{#ff9cd4}can\ \color{#ffb0dd}call\ \color{#ffd1eb}me\ \color{#ffe6f4}Nad\ \color{#ffffff}or\ \color{#ffb0dd}Nar\color{#ffd1eb}ra\color{#ffe6f4}tor\ \color{#ffffff}tho.\ \color{#ffe6f4}Ni\color{#ffd1eb}ckn\color{#ffe6f4}ames\ \color{#ffffff}are\ \color{#ffe6f4}also\ \color{#ffd1eb}ok\ \color{#ffb0dd}un\color{#ff9cd4}less\ \color{#ffb0dd}I\ \color{#ffd1eb}fi\color{#ffe6f4}nd\ \color{#ffd1eb}them\ \color{#ffb0dd}of\color{#ff9cd4}fens\color{#ffb0dd}ive.\color{#ffb0dd}໒꒱\$$ $$\color{#ffd1eb}꒰১\ \color{#ffd1eb}Ju\color{#ffffff}st\ \color{#ffffff}to\ \color{#ffe6f4}ma\color{#ffd1eb}ke\ \color{#ffb0dd}sure,\ \color{#ffb0dd}you\ \color{#ffb0dd}can\ \color{#ffb0dd}che\color{#ffb0dd}ck\ \color{#ffb0dd}my\$$ <a href="https://pronouns.cc/@Nadnad">Prns.cc</a> $\color{#ffb0dd}!\ \color{#ffb0dd}໒꒱$

$$\color{#ffffff}꒰১\ \color{#ffffff}I\ \color{#ffe6f4}LO\color{#ffd1eb}VE\ \color{#ffb0dd}CUTE\color{#ff9cd4}CORE/\color{#ffb0dd}JOJI\color{#ffd1eb}FUKU!\ \color{#ffe6f4}I\ \color{#ffffff}also\ \color{#ffb0dd}en\color{#ffd1eb}joy\ \color{#ffe6f4}psy\color{#ffffff}cho\color{#ffe6f4}lo\color{#ffd1eb}gi\color{#ffe6f4}cal\ \color{#ffffff}films..\ \color{#ffe6f4}But\ \color{#ffd1eb}really\ \color{#ffb0dd}I'll\ \color{#ff9cd4}watch\ \color{#ffb0dd}any\color{#ffd1eb}thi\color{#ffe6f4}ng\ \color{#ffd1eb}that\ \color{#ffb0dd}makes\ \color{#ff9cd4}you\ \color{#ffb0dd}re\color{#ffb0dd}flect\ \color{#ffb0dd}໒꒱\$$ $$\color{#ffd1eb}꒰১\ \color{#ffd1eb}upon\ \color{#ffffff}so\color{#ffffff}me\color{#ffe6f4}thing!\ \color{#ffd1eb}I'm\ \color{#ffb0dd}also\ \color{#ff9cd4}in\color{#ffb0dd}te\color{#ffd1eb}res\color{#ffe6f4}ted\ \color{#ffffff}in\ \color{#ffe6f4}psy\color{#ffd1eb}cho\color{#ffb0dd}lo\color{#ff9cd4}gy\ \color{#ffb0dd}he\color{#ffd1eb}he..\ \color{#ffd1eb}໒꒱$$
...
$$\color{#ffffff}꒰১\  \color{#ffffff}I\ \color{#ffe6f4}love\ \color{#ffd1eb}sha\color{#ffb0dd}ri\color{#ff9cd4}ng\ \color{#ffb0dd}stu\color{#ffd1eb}ff..\ \color{#ffe6f4}Tal\color{#ffffff}ki\color{#ffe6f4}ng\ \color{#ffd1eb}ab\color{#ffb0dd}out\ \color{#ff9cd4}some\color{#ffb0dd}thi\color{#ffd1eb}ng\ \color{#ffe6f4}I\ \color{#ffffff}li\color{#ffe6f4}ke\ \color{#ffd1eb}is\ \color{#ffb0dd}my\ \color{#ff9cd4}love\ \color{#ffb0dd}lan\color{#ffd1eb}gu\color{#ffffff}age!\ \color{#ffffff}໒꒱$$

$$\color{#ffffff}꒰১\  \color{#ffffff}If\ \color{#ffe6f4}you\ \color{#ffd1eb}ha\color{#ffb0dd}ve\ \color{#ff9cd4}any\ \color{#ffb0dd}qu\color{#ffd1eb}es\color{#ffe6f4}ti\color{#ffffff}ons,\ \color{#ffe6f4}you\ \color{#ffd1eb}can\ \color{#ffd1eb}ask\ \color{#ffb0dd}me\ \color{#ff9cd4}th\color{#ffb0dd}em\ \color{#ffe6f4}on\ \color{#ffffff}my\ \color{#ffe6f4}ata\ \color{#ffb0dd}or\ \color{#ff9cd4}st\color{#ffb0dd}ra\color{#ffd1eb}wp\color{#ffd1eb}age!\ \color{#ffd1eb}໒꒱$$
...
$$\color{#ffffff}୨୧\ \color{#ffffff}Fi\color{#ffe6fb}ght\ \color{#ffd4f8}Cl\color{#ed8cdd}ub\  \color{#d457bf}୨୧$$

$$\color{#ffd4f8}𖹭\  \color{#ffd4f8}M\color{#ed8cdd}HA\ \color{#d457bf}𖹭$$

$$\color{#ffffff}୨୧\  \color{#ffe6fb}EN\color{#ffd4f8}A:\ \color{#ed8cdd}Dr\color{#d457bf}ea\color{#c230aa}m\ \color{#9e0d88}BB\color{#c230aa}Q\ \color{#d457bf}୨୧$$

$$\color{#ffffff}𖹭\  \color{#ffe6fb}Sli\color{#ffd4f8}me\ \color{#ed8cdd}Ran\color{#d457bf}cher\ \color{#c230aa}𖹭$$

$$\color{#ffffff}୨୧\  \color{#ffe6fb}Null\color{#ffd4f8}scape\ \color{#ed8cdd}୨୧$$

$$\color{#ffffff}𖹭\  \color{#ffe6fb}D\color{#ffd4f8}BH\ \color{#ed8cdd}𖹭$$

$$\color{#ffffff}୨୧\  \color{#ffe6fb}Av\color{#ffd4f8}A\ \color{#ffd4f8}+\ \color{#ed8cdd}Av\color{#d457bf}MC\ \color{#c230aa}୨୧$$
...
$$\color{#ffffff}୨୧\  \color{#ffe6fb}N\color{#ffd4f8}SO\ \color{#ed8cdd}୨୧$$

$$\color{#ffffff}𖹭\  \color{#ffe6fb}DO\color{#ffd4f8}OM\ \color{#ed8cdd}Eter\color{#d457bf}nal\ \color{#c230aa}𖹭$$

$$\color{#ffffff}୨୧\ \color{#ffe6fb}Su\color{#ffd4f8}ici\color{#ed8cdd}de\ \color{#d457bf}Ro\color{#c230aa}om\ \color{#9e0d88}୨୧$$
...
$$\color{#ffffff}✦\ \color{#ffe6f4}Bl\color{#ffd1eb}ue\ \color{#ffb0dd}-\ \color{#ff9cd4}Av\color{#ffb0dd}A\ \color{#ffd1eb}+\ \color{#ffe6f4}Av\color{#ffffff}MC\ \color{#ffe6f4}✦$$
...
$$\color{#ffffff}✦\ \color{#ffe6f4}Re\color{#ffd1eb}d\ \color{#ffb0dd}-\ \color{#ff9cd4}Av\color{#ffb0dd}A\ \color{#ffd1eb}+\ \color{#ffe6f4}Av\color{#ffffff}MC\ \color{#ffe6f4}✦$$
...
$$\color{#ffffff}✦\ \color{#ffe6f4}Si\color{#ffd1eb}mon\ \color{#ffb0dd}Hen\color{#ff9cd4}rik\color{#ffb0dd}ss\color{#ffd1eb}on\ \color{#ffe6f4}-\ \color{#ffffff}Cr\color{#ffe6f4}y\ \color{#ffd1eb}Of\ \color{#ffb0dd}Fe\color{#ff9cd4}ar\ \color{#ffb0dd}✦$$
...
<p align="center">
 $$\color{#ff9cd4}⊹₊\color{#ffb0dd}˚‧\color{#ffd1eb}‿︵\color{#ffe6f4}₊\ \color{#ffffff}୨✦୧\ \color{#ffe6f4}₊\ \color{#ffd1eb}︵‿\color{#ffb0dd}‧˚\color{#ff9cd4}₊⊹$$
</p>
...
<p align="center">
$$\color{#ffffff}✦\ \color{#ffffff}I\ \color{#ffe6f4}al\color{#ffd1eb}mo\color{#ffb0dd}st\ \color{#ff9cd4}nev\color{#ffb0dd}er\ \color{#ffd1eb}start\ \color{#ffe6f4}con\color{#ffffff}vos. \color{#ffe6f4}It's\ \color{#ffd1eb}pre\color{#ffb0dd}tty\ \color{#ff9cd4}aw\color{#ffb0dd}kwa\color{#ffd1eb}rd\ \color{#ffe6f4}for\ \color{#ffffff}me..\ \color{#ffffff}✦$$
  </p>
...
<details>
<summary>  $$\color{#ffffff}TH\color{#ffe6f4}IN\ \color{#ffd1eb}IC\color{#ffb0dd}E!$$</summary>
 
$$\color{#ffffff}୨୧\ \color{#ffe6fb}13-/20+\ \color{#ffd4f8}year\ \color{#ed8cdd}olds\ \color{#ed8cdd}୨୧$$

$$\color{#ffffff}✦\ \color{#ffe6fb}For\color{#ffd4f8}sa\color{#ed8cdd}ken\ \color{#d457bf}fa\color{#c230aa}ns\ \color{#c230aa}✦$$

$$\color{#ffffff}୨୧\ \color{#ffe6fb}Ver\color{#ffd4f8}ity\ \color{#ed8cdd}ser\color{#d457bf}ies\ \color{#c230aa}fa\color{#d457bf}ns\ \color{#d457bf}୨୧$$

$$\color{#ffffff}✦\ \color{#ffe6fb}Ani\color{#ffd4f8}mal\ \color{#ed8cdd}hos\color{#d457bf}pi\color{#c230aa}tal\ \color{#d457bf}fa\color{#ed8cdd}ns\ \color{#ed8cdd}✦$$

$$\color{#ffffff}୨୧\ \color{#ffe6fb}TA\color{#ffd4f8}DC\ \color{#ed8cdd}fa\color{#d457bf}ns\ \color{#d457bf}୨୧$$

$$\color{#ffffff}✦\ \color{#ffe6fb}Fic\color{#ffd4f8}tion\ \color{#ed8cdd}ki\color{#d457bf}ns\ \color{#d457bf}✦$$

$$\color{#ffffff}✦\ \color{#ffe6fb}BK\color{#ffd4f8}DK\ \color{#ed8cdd}shi\color{#d457bf}pp\color{#d457bf}ers\ \color{#d457bf}✦$$

$$\color{#ffffff}୨୧\ \color{#ffe6fb}Dry\ \color{#ffd4f8}peo\color{#ed8cdd}ple\ \color{#ed8cdd}୨୧$$
...
<div align=center>
 <details>
<summary>$$\color{#ffffff}D\color{#ffe6fb}N\color{#ffd4f8}I!$$</summary>

$$\color{#ffffff}✦\ \color{#ffffff}11-/30+\ \color{#ffe6f4}year\ \color{#ffd1eb}olds\ \color{#ffd1eb}✦$$

$$\color{#ffffff}୨୧\ \color{#ffffff}Pr\color{#ffe6f4}osh\color{#ffd1eb}ipp\color{#ffb0dd}ers/\color{#ff9cd4}da\color{#ffb0dd}rk\color{#ffd1eb}shi\color{#ffe6f4}pp\color{#ffffff}ers\ \color{#ffffff}୨୧$$

$$\color{#ffffff}✦\ \color{#ffffff}Ra\color{#ffe6f4}ci\color{#ffd1eb}sts/\color{#ffffff}Xeno\color{#ffe6f4}ph\color{#ffd1eb}obes\ \color{#ffd1eb}✦$$

$$\color{#ffffff}✦\ \color{#ffffff}Ho\color{#ffe6f4}mo\color{#ffd1eb}pho\color{#ffb0dd}bes\ \color{#ffb0dd}✦$$

$$\color{#ffffff}୨୧\ \color{#ffffff}Ra\color{#ffe6f4}dq\color{#ffd1eb}ue\color{#ffb0dd}ers\ \color{#ffb0dd}୨୧$$

$$\color{#ffffff}✦\ \color{#ffffff}Pe\color{#ffe6f4}op\color{#ffd1eb}le\ \color{#ffb0dd}with\ \color{#ff9cd4}bot\ \color{#ffb0dd}hu\color{#ffd1eb}mo\color{#ffe6f4}ur\ \color{#ffe6f4}✦$$

$$\color{#ffffff}୨୧\ \color{#ffffff}To\color{#ffe6f4}xic\ \color{#ffd1eb}non-\color{#ffb0dd}sha\color{#ff9cd4}ring\ \color{#ffb0dd}yu\color{#ffd1eb}mes\ \color{#ffd1eb}୨୧$$

$$\color{#ffffff}✦\ \color{#ffffff}In\color{#ffe6f4}ce\color{#ffd1eb}st\ \color{#ffb0dd}su\color{#ff9cd4}pp\color{#ffb0dd}or\color{#ffd1eb}ers\ \color{#ffd1eb}✦$$

$$\color{#ffffff}୨୧\ \color{#ffffff}Zoo\color{#ffe6f4}phi\color{#ffd1eb}lia\ \color{#ffb0dd}su\color{#ff9cd4}pp\color{#ffb0dd}or\color{#ffd1eb}ers\ \color{#ffd1eb}୨୧$$
...
<p align="center">
 ...
 <img src="https://files.catbox.moe/6rcr22.png"  width="1000" >
...
<p align="center">
$$\color{#ffffff}✦\ \color{#ffffff}If\ \color{#ffe6f4}you\color{#ffd1eb}'re\ \color{#ffb0dd}lo\color{#ff9cd4}ok\color{#ffb0dd}ing\ \color{#ffd1eb}for\ \color{#ffe6f4}more\ \color{#ffffff}in\color{#ffe6f4}fo,\ \color{#ffd1eb}check\ \color{#ffb0dd}out\ \color{#ff9cd4}the\color{#ffb0dd}se\ \color{#ffd1eb}li\color{#ffe6f4}nks! \color{#ffffff}✦$$
</p>


<p align="center">
$$\color{#ffffff}✦•\color{#ffe6f4}๑⋅\color{#ffd1eb}⋯$$ <a href="https://nadnad.atabook.org">Ata 𖹭</a> $\color{#ffd1eb}{⋮}$ <a href="https://nadnad2.straw.page">Sp 𖹭! (heavy wip..)</a> $\color{#ffb0dd}{⋮}$ <a href="https://pronouns.cc/@Nadnad">Prns.cc 𖹭</a> $\color{#ffb0dd}{⋮}$ <a href="https://en.pronouns.page/@Nadnad">Prns.page 𖹭</a> $\color{#ffd1eb}{⋮}$ <a href="https://guns.lol/nadnadd ">Guns.lol 𖹭</a> $$\color{#ffd1eb}⋯\color{#ffe6f4}⋅๑\color{#ffffff}•✦$$
</p>
...
<p align=center>
<img src="https://files.catbox.moe/p7edxw.png">
</p>
